...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler({SocketTimeoutException.class, OpenAiHttpException.class})
    public ResponseEntity<ErrorMessage> handleUnavailableOpenAi(Exception exception) {
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(new ErrorMessage("Chat service is currently unavailable. Please try again later."));
    }
